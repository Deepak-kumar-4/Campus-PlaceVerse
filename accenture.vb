...
Public Class accenture
    ...
    Private Sub loginbutton_Click(sender As Object, e As EventArgs) Handles loginbutton.Click
        If ComboBox1.SelectedIndex <> -1 Then
            ...
            Catch ex As Exception
                MessageBox.Show("You have already Apllied", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                'MsgBox(ex.Message)
            End Try
        Else
  ...
  End Sub
    ...
    Private Sub accenture_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        username.Text = sid
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        If ComboBox1.SelectedIndex = 0 Then
            Label5.Text = "     Roles and Responsibilities
